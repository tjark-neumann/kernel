...
/* pack foreground/background pair into the color byte */
...
/* tiny strlen, since there is no libc */
 ...
 * must NOT be named main() and must NOT return into a
...
void kernel_main(void) {
	...
	/* nothing left to do. i think returning would go back to boot.s, which halts
